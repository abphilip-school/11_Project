...
class SnakeGame:
    ...
    def update(self):
        ...
        for food in self.food: 
            if self.snake.getHead() == food:
                ...
                self.addFood()
                self.snake.grow()
                self.score += len(self.snake.pieces) * 5
    ...
    def drawDeath(self):
        ...
        self.screen.blit(self.font.render("Game over!  Press 'Space' to start a New Game", 1, (255, 255, 255)), (46, 150))
        self.screen.blit(self.font.render("Your score is: %d" % self.score, 1, (0, 255, 0)), (208, 200))
        pygame.display.flip()
